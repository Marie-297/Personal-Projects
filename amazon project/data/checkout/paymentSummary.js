...
export function renderPaymentSummary() {
  ...
  const orderTotal = totalAfterTax + totalBeforeTax;
  ...
  `
    ...
    <div class="payment-summary-row">
      ...
      <div class="payment-summary-money">$${moneyFormat(totalAfterTax)}</div>
    </div>

    <div class="payment-summary-row total-row">
      <div>Order total:</div>
      <div class="payment-summary-money">$${moneyFormat(orderTotal)}</div>
    </div>
